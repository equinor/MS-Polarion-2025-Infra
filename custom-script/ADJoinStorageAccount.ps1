...
$SubscriptionId = "5a0bb1d0-a00b-40d4-9fc4-4f0e3fd71c4e"
$ResourceGroupName = "S499-MSClickdata-QA"
$StorageAccountName = "msclickdataqa"
$SamAccountName = "msclickdataqa"
...
$OuDistinguishedName = "OU=S499,OU=Omnia Classic,OU=Cloud Servers,OU=Servers,DC=statoil,DC=net"
